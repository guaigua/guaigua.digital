...
function createCMAHttpClient(params) {
  ...
  `contentful-management.js/${"6.1.2"}`, params.application, params.integration, params.feature);
...
function raiseDeprecationWarning(method) {
  console.warn([`Deprecated: Space.${method}() will be removed in future major versions.`, null, `Please migrate your code to use Environment.${method}():`, 'https://contentful.github.io/contentful-management.js/contentful-management/latest/globals.html#createenvironmentapi', null].join('\n'));
}
...
function createSpaceApi({
  ...
  const _entities$scheduledAc = _entities__WEBPACK_IMPORTED_MODULE_3__["default"].scheduledAction,
  ...
  return {
    ...
    getScheduledActions(query) {
      return http.get('scheduled_actions', Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__["createRequestConfig"])({
        query: query
      })).then(response => wrapScheduledActionCollection(http, response.data), _error_handler__WEBPACK_IMPORTED_MODULE_2__["default"]);
    },
    ...
    createScheduledAction(data) {
      return http.post('scheduled_actions', data).then(response => wrapScheduledAction(http, response.data), _error_handler__WEBPACK_IMPORTED_MODULE_2__["default"]);
    },
    ...
    */
     ...
     * ```
     */
    createEnvironmentAliasWithId(id, data) {
      return http.put('environment_aliases/' + id, data).then(response => wrapEnvironmentAlias(http, response.data), _error_handler__WEBPACK_IMPORTED_MODULE_2__["default"]);
    },
...
function createAppInstallationApi(http) {
  return {
    ...
    delete: function _delete() {
      const raw = this.toPlainObject();
      return http.delete(`app_installations/${raw.sys.appDefinition.sys.id}`).then(() => {// do nothing
      }, _error_handler__WEBPACK_IMPORTED_MODULE_2__["default"]);
    }
  };
}
...
const wrapAppInstallationCollection = Object(_common_utils__WEBPACK_IMPORTED_MODULE_4__["wrapCollection"])(wrapAppInstallation);
...
function createDeleteScheduledAction(http) {
  return function () {
    const self = this;
    return http.delete('scheduled_actions/' + self.sys.id).then(response => wrapScheduledAction(http, response.data), _error_handler__WEBPACK_IMPORTED_MODULE_4__["default"]);
  };
}
...
function wrapScheduledAction(http, data) {
  const scheduledAction = Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__["toPlainObject"])(lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_0___default()(data));
