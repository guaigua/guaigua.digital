...
var VersionHeader = function VersionHeader(version) {
  return {
    headers: {
...
function createCMAHttpClient(params) {
  ...
  "contentful-management.js/".concat("6.1.2"), params.application, params.integration, params.feature);
  var requiredHeaders = {
...
function createEnvironmentApi(_ref) {
  ...
  var wrapEnvironment = _entities__WEBPACK_IMPORTED_MODULE_2__["default"].environment.wrapEnvironment;
  var _entities$contentType = _entities__WEBPACK_IMPORTED_MODULE_2__["default"].contentType,
  ...
  var _entities$entry = _entities__WEBPACK_IMPORTED_MODULE_2__["default"].entry,
      wrapEntry = _entities$entry.wrapEntry,
      wrapEntryCollection = _entities$entry.wrapEntryCollection;
  var _entities$asset = _entities__WEBPACK_IMPORTED_MODULE_2__["default"].asset,
      wrapAsset = _entities$asset.wrapAsset,
      wrapAssetCollection = _entities$asset.wrapAssetCollection;
  var _entities$locale = _entities__WEBPACK_IMPORTED_MODULE_2__["default"].locale,
      wrapLocale = _entities$locale.wrapLocale,
      wrapLocaleCollection = _entities$locale.wrapLocaleCollection;
  var wrapSnapshotCollection = _entities__WEBPACK_IMPORTED_MODULE_2__["default"].snapshot.wrapSnapshotCollection;
  var wrapEditorInterface = _entities__WEBPACK_IMPORTED_MODULE_2__["default"].editorInterface.wrapEditorInterface;
  var wrapUpload = _entities__WEBPACK_IMPORTED_MODULE_2__["default"].upload.wrapUpload;
  var _entities$uiExtension = _entities__WEBPACK_IMPORTED_MODULE_2__["default"].uiExtension,
  ...
  var _entities$appInstalla = _entities__WEBPACK_IMPORTED_MODULE_2__["default"].appInstallation,
  ...
  return {
    ...
    getEntrySnapshots: function getEntrySnapshots(entryId) {
      var query = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      return http.get("entries/".concat(entryId, "/snapshots"), Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_0__["createRequestConfig"])({
        query: query
      })).then(function (response) {
    ...
    getContentTypeSnapshots: function getContentTypeSnapshots(contentTypeId) {
      var query = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      return http.get("content_types/".concat(contentTypeId, "/snapshots"), Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_0__["createRequestConfig"])({
        query: query
      })).then(function (response) {
        return wrapSnapshotCollection(http, response.data);
      }, _error_handler__WEBPACK_IMPORTED_MODULE_4__["default"]);
    ...
    createTag: function createTag(id, name) {
      return http.put("tags/".concat(id), {
        ...
        return Object(_entities_tag__WEBPACK_IMPORTED_MODULE_3__["wrapTag"])(http, response.data);
      }, _error_handler__WEBPACK_IMPORTED_MODULE_4__["default"]);
    },
    getTags: function getTags() {
      var query = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      return http.get('tags', Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_0__["createRequestConfig"])({
        query: query
      })).then(function (response) {
        return Object(_entities_tag__WEBPACK_IMPORTED_MODULE_3__["wrapTagCollection"])(http, response.data);
      }, _error_handler__WEBPACK_IMPORTED_MODULE_4__["default"]);
    },
...
function raiseDeprecationWarning(method) {
  console.warn(["Deprecated: Space.".concat(method, "() will be removed in future major versions."), null, "Please migrate your code to use Environment.".concat(method, "():"), 'https://contentful.github.io/contentful-management.js/contentful-management/latest/globals.html#createenvironmentapi', null].join('\n'));
}
...
function createSpaceApi(_ref) {
  ...
  var _entities$scheduledAc = _entities__WEBPACK_IMPORTED_MODULE_3__["default"].scheduledAction,
  ...
  return {
    ...
    getScheduledActions: function getScheduledActions(query) {
      return http.get('scheduled_actions', Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__["createRequestConfig"])({
        query: query
      })).then(function (response) {
        return wrapScheduledActionCollection(http, response.data);
      }, _error_handler__WEBPACK_IMPORTED_MODULE_2__["default"]);
    },
    ...
    createScheduledAction: function createScheduledAction(data) {
      return http.post('scheduled_actions', data).then(function (response) {
    ...
    */
     ...
     * ```
     */
    createEnvironmentAliasWithId: function createEnvironmentAliasWithId(id, data) {
      return http.put('environment_aliases/' + id, data).then(function (response) {
...
function createAppInstallationApi(http) {
  return {
    ...
    "delete": function _delete() {
      var raw = this.toPlainObject();
      return http["delete"]("app_installations/".concat(raw.sys.appDefinition.sys.id)).then(function () {// do nothing
      }, _error_handler__WEBPACK_IMPORTED_MODULE_2__["default"]);
    }
  };
}
...
var wrapAppInstallationCollection = Object(_common_utils__WEBPACK_IMPORTED_MODULE_4__["wrapCollection"])(wrapAppInstallation);
...
/* harmony import */ var _tag__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./tag */ "./entities/tag.ts");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  tag: _tag__WEBPACK_IMPORTED_MODULE_21__,
...
function wrapScheduledAction(http, data) {
  var scheduledAction = Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__["toPlainObject"])(lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_0___default()(data));
  ...
  return Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__["freezeSys"])(scheduledActionWithMethods);
}
...
function createDeleteTag(http) {
  return function () {
    ...
    .then(function () {}, _error_handler__WEBPACK_IMPORTED_MODULE_4__["default"]);
  };
}
function createUpdateTag(http) {
  return function () {
    var self = this;
    return http.put('tags/' + self.sys.id, {
      name: self.name,
      sys: {
        id: self.sys.id
      }
    }, Object(_common_utils__WEBPACK_IMPORTED_MODULE_2__["VersionHeader"])(self.sys.version)).then(function (response) {
...
function wrapTag(http, data) {
  var tag = Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__["toPlainObject"])(lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_0___default()(data));
